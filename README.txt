...
*RFID tags in EEPROM needs to be numbered, 1,2,3....
...
- Copy all files to arduino 'libraries' directory
...
- For more details, open files:

	+ \libraries\AT24xxRFID\AT24xxRFID.h
	+ \libraries\AT24xxRFID\AT24xxRFID.cpp
